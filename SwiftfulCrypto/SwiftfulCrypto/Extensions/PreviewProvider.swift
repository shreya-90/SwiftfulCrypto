...
class DeveloperPreview {
    ...
    let stat1 = StatisticModel(title: "Market cap", value: "$12.58n", percentageChange: 25.35)
    let stat2 = StatisticModel(title: "Total Volume", value: "$1.23Tr")
    let stat3 = StatisticModel(title: "Portflio value", value: "$50.5k", percentageChange: -12.34)
